...
public class SecurityUtils {
    ...
    public static final String CLAIMS_NAMESPACE = "https://www.casahub.com/roles";
    ...
    private static Collection<String> getRolesFromClaims(Map<String, Object> claims) {
        var roles = (List<String>) claims.get(CLAIMS_NAMESPACE);

        // 2. If roles are found, return them.
        //    If roles are NULL, return an empty list instead of null!
        if (roles != null) {
            return roles;
        }
